...
| `VITE_INITIAL_HEADERS` | Initial HTTP headers (JSON) | `'{"Content-Type":"application/json","Authorization":"Bearer your-token"}'` | ❌ |
...
| `headers` | HTTP headers for requests (JSON) | `?headers={"Authorization":"Bearer token123"}` |
